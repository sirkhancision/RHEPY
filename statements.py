...
def print_statements(language, types):
    ...
    if language == PORTUGUESE:
        ...
        # Par de Frases 13
        types["f_2"], types["c_3"] = statement(
            "Eu tenho sido mais orientado a relacionamentos do que a "
            "objetivos.",
        ...
        # Par de Frases 15
        types["h_5"], types["d_1"] = statement(
            "Tem sido difícil para mim parar de considerar alternativas e "
            "fazer algo definitivo.",
        ...
        # Par de Frases 17
        types["a_9"], types["f_2"] = statement(
            "Minha relutância em me envolver demais tem me causado problemas "
            "com as pessoas.",
        ...
        # Par de Frases 21
        types["g_8"], types["c_3"] = statement(
            'Eu frequentemente senti a necessidade de ser um "pilar de '
            'força".',
        ...
        # Par de Frases 22
        types["h_5"], types["a_9"] = statement(
            "Eu normlamente tenho interesse em fazer perguntas difíceis e "
            "manter minha independência.",
            "Eu normalmente tenho interesse em manter minha estabilidade e "
            "paz de espírito.",
            "H",
            "A",
            types["h_5"],
        ...
        types["i_7"], types["g_8"] = statement(
            ...
            "Eu costumo me preocupar em ser explorado se abaixar minha"
            "guarda.",
            "I",
            "G",
            types["i_7"],
        ...
        # Par de Frases 32
        types["h_5"], types["b_6"] = statement(
            "Perseguir meus interesses pessoais tem sido mais importante para "
            "mim do que ter estabilidade e segurança.",
            "Ter estabilidade e segurança tem sido mais importante para mim "
            "do que perseguir meus interesses pessoais.",
            "H",
            "B",
            types["h_5"],
            types["b_6"],
        ...
        # Par de Frases 35
        types["i_7"], types["f_2"] = statement(
            "Eu tenho sido apreciado pela minha determinação e "
            "desenvoltura.",
        ...
        # Par de Frases 51
        types["d_1"], types["h_5"] = statement(
            "Geralmente, eu tive convicções fortes e uma noção de como as "
            "coisas deveriam ser.",
        ...
        types["f_2"], types["b_6"] = statement(
            ...
            'Eu muitas vezes "testei" aqueles que amo para ver se eles '
            "realmente estavam lá para mim.",
            "F",
            "B",
            types["f_2"],
            types["b_6"],
        ...
        # Par de Frases 63
        types["b_6"], types["c_3"] = statement(
            "Mesmo tendo tido sucesso, tendi a duvidar das minhas"
            "habilidades.",
            "Mesmo tendo tido contratempos, sempre tive muita confiança nas "
            "minhas habilidades.",
            "B",
            "C",
            types["b_6"],
        ...
        # Par de Frases 65
        types["f_2"], types["g_8"] = statement(
            "Eu tenho proporcionado muitas pessoas com atenção e apoio"
            "emocional.",
        ...
        types["d_1"], types["i_7"] = statement(
            ...
            "Eu tenho sido um pouco descompromissado e permissivo comigo"
            "mesmo.",
            "D",
            "I",
            types["d_1"],
        ...
        # Par de Frases 72
        types["c_3"], types["h_5"] = statement(
            "Eu tenho buscado atividades que tinham um potencial substancial "
            "de recompensa e reconhecimento pessoal.",
        ...
        types["e_4"], types["f_2"] = statement(
            ...
            "mundo.",
            "Eu tendi a dar meu afeto com facilidade e querer me expandir "
            "para os outros.",
            "E",
            "F",
            types["e_4"],
        ...
        # Par de Frases 86
        types["e_4"], types["i_7"] = statement(
            "Eu perdi oportunidades porque não me senti capaz de"
            "aproveitá-las.",
        ...
        # Par de Frases 89
        types["f_2"], types["a_9"] = statement(
            "Eu tenho tido uma tendência a ser um pouco intenso com as"
            "pessoas.",
        ...
        # Par de Frases 95
        types["f_2"], types["b_6"] = statement(
            "Eu frequentemente tentei descobrir como eu poderia me aproximar "
            "mais dos outros.",
            "Eu frequentemente tentei descobrir o que os outros queriam de"
            "mim.",
            "F",
            "B",
            types["f_2"],
        ...
        # Par de Frases 98
        types["i_7"], types["a_9"] = statement(
            "Durante a maior parte da minha vida, tenho sido uma pessoa "
            "turbulenta que teve muitas emoções voláteis.",
            "Durante a maior parte da minha vida, tenho sido uma pessoa "
            "estável e tranquila por fora, porém profunda por dentro.",
            "I",
            "A",
            types["i_7"],
            types["a_9"],
        ...
        # Par de Frases 102
        types["i_7"], types["d_1"] = statement(
            'Geralmente, eu tenho gostado de "me deixar levar" e levar as '
            "coisas a seus limites.",
            "Geralmente, eu não tenho gostado muito de perder o controle de "
            "mim mesmo.",
            "I",
            "D",
            types["i_7"],
        ...
        # Par de Frases 110
        types["g_8"], types["a_9"] = statement(
            "Eu geralmente gostei de situações de alta pressão, mesmo as"
            "difíceis.",
            "Eu geralmente não gostei de estar em situações de alta pressão "
            "ou difíceis.",
            "G",
            "A",
            types["g_8"],
        ...
        types["f_2"], types["h_5"] = statement(
            ...
            "Encontrar formas alternativas de ver e fazer as coisas tem sido "
            "uma prioridade minha.",
            "F",
            "H",
            types["f_2"],
        ...
        types["e_4"], types["a_9"] = statement(
            ...
            "Com frequência, tenho sido atraído por situações que me fazem "
            "sentir calmo e à vontade.",
            "E",
            "A",
            types["e_4"],
            types["a_9"],
        ...
        types["h_5"], types["g_8"] = statement(
            ...
            "perseguir "
            "meus interesses.",
            "Eu tenho sido prático e esperado que meu trabalho tenha "
        ...
        # Par de Frases 122
        types["e_4"], types["i_7"] = statement(
            "Eu tenho tido uma tendência a ficar pensando em "
            "coisas do passado.",
        ...
        # Par de Frases 128
        types["f_2"], types["d_1"] = statement(
            "Eu tenho dado muito contato físico para assegurar os outros de "
            "como eu me sinto em relação a eles.",
        ...
        types["h_5"], types["a_9"] = statement(
            ...
            "Eu tenho preferido não passar meu tempo refletindo sobre "
            "assuntos perturbadores e assustadores.",
            "H",
            "A",
            types["h_5"],
            types["a_9"],
        ...
        # Par de Frases 131
        types["f_2"], types["b_6"] = statement(
            "Eu já me meti em problemas com as pessoas por ser muito "
            "intrusivo e interferente.",
            "Eu já me meti em problemas com as pessoas por ser muito evasivo "
            "e taciturno.",
            "F",
            "B",
            types["f_2"],
        ...
        types["a_9"], types["i_7"] = statement(
            ...
            "Não conseguir desacelerar tem sido um dos meus principais"
            "problemas.",
            "A",
            "I",
            types["a_9"],
        ...
        types["c_3"], types["a_9"] = statement(
            ...
            "Grandes adversidades me fizeram sentir desencorajado e "
            "resignado.",
            "C",
            "A",
            types["c_3"],
        ...
        types["b_6"], types["h_5"] = statement(
            ...
            "Eu geralmente escolhi viver no limite e depender dos outros o "
            "mínimo possível.",
            "B",
            "H",
            types["b_6"],
        ...
        types["h_5"], types["c_3"] = statement(
            ...
            "Eu evitei intimidade quando eu temi que não seria capaz de "
            "atender às expectativas das pessoas sobre mim.",
            "H",
            "C",
            types["h_5"],
            types["c_3"],
